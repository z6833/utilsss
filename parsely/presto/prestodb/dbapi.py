...
from .transaction import Transaction, IsolationLevel, NO_TRANSACTION
...
class Connection(object):
    ...
    def __init__(
        ...
        self._http_session = client.PrestoRequest.http.Session()
...
class Cursor(object):
    ...
    def execute(self, operation, params=None):
        self._query = client.PrestoQuery(self._request, sql=operation)
    ...
    def fetchone(self):
        ...
        try:
            ...
            raise exceptions.OperationalError(str(err))
